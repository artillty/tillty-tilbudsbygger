/* ============================================================
   Danske postnumre — postnr. -> bynavn

   Ligger lokalt og ikke som opslag mod en API, af samme grund som fontene:
   sælgere sidder hos kunder uden net, og et tilbud må ikke mangle bynavnet,
   fordi der ikke var forbindelse. Testen fejler, hvis siden laver en
   ekstern request.

   Kilde: Dataforsyningen (DAWA), https://api.dataforsyningen.dk/postnumre
   Hentet 2026-09-04. Opdater med:
     curl -s https://api.dataforsyningen.dk/postnumre | …  (se README)
   ============================================================ */
